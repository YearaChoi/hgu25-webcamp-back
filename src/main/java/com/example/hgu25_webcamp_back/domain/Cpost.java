...
public class Cpost {
    ...
    private Cpost(String title, String description, String category, String imageName, String imagePath) {
        this.title = title;
    ...
    public static Cpost of(String title, String description, String category, String imageName, String imagePath) {
        return new Cpost(title, description, category, imageName, imagePath);
    }
